...
def contactUs():
    ...
    textLable = Label(textFrame,text=text,fg="white",bg="black",font=("arial",15))
    textLable.place(rely=0.1)
    emailLabel = Label(rightFrame,text = "Email :",fg="white",font=("arial",15),bg="black")
    ...
    contactLabel = Label(rightFrame,text = "Contact :",fg="white",font=("arial",15),bg="black")
    ...
    sendBtn = Button(rightFrame,text="Send",width=25,bg="white")
...
def aboutUs():
    frameBottom = Frame(root,bg="white")
    frameBottom.place(rely=0.2, relwidth=1, relheight=1)
    # rightFrame = Frame(frameBottom,bg="white")
    # rightFrame.place(relx=0.2,rely=0,relwidth=1,relheight=1)

    image = Image.open("library.jpg")

    # resize_image = image.resize((550, 350))

    img = ImageTk.PhotoImage(image)

    # create label and add resize image
    label1 = Label(frameBottom,image=img)
    label1.image = img
    label1.place(relx=0,rely=0.02,relwidth=1,relheight=0.3)
    teamLabel = Label(frameBottom,text="Team",bg="white",font=("Arial",20,"bold"))
    teamLabel.place(rely=0.35,relx=0.4)
    teamText = Label(frameBottom,text="we are the development team i am vikas rai and i am the developer and this is my team we are working on the project known as library\nmanagement system.",bg="white",font=("Arial",12))
    teamText.pack(padx=20,pady=300)
    label2 = Label(frameBottom,image=img)
    label2.image = img
    label2.place(relx=0,rely=0.47,relwidth=0.2,relheight=0.3)
    proManagerLabel = Label(frameBottom,text="Project Manager",bg="white",font=("Arial",20,"bold"))
    proManagerLabel.place(rely=0.47,relx=0.22)
    proManagerText = Label(frameBottom,text="we are the development team i am vikas rai and i am the developer and this is my team we are working on the project known as library\nmanagement system.",bg="white",font=("Arial",12))
    proManagerText.place(relx=0.22,rely=0.52)
    label2 = Label(frameBottom,image=img)
    label2.image = img
    label2.place(relx=0,rely=0.59,relwidth=0.2,relheight=0.3)
    devLabel = Label(frameBottom,text="Developer",bg="white",font=("Arial",20,"bold"))
    devLabel.place(rely=0.59,relx=0.22)
    devText = Label(frameBottom,text="we are the development team i am vikas rai and i am the developer and this is my team we are working on the project known as library\nmanagement system.",bg="white",font=("Arial",12))
    devText.place(relx=0.22,rely=0.65)
...
#     sideFrame = Frame(frameBottom,bg="#f5cf51")
#     sideFrame.place(relx=0,rely=0,relwidth=0.2,relheight=1)

#     aboutUsBtn = Button(sideFrame,text="About Us",bg="#f5cf51",fg="white",font=("Arial",15),bd=0,command=aboutUs)
#     aboutUsBtn.place(rely=0.3,relx=0.2)
    
#     contactUsBtn = Button(sideFrame,text="Contact Us",bg="#f5cf51",fg="white",font=("Arial",15),bd=0,command=contactUs)
#     contactUsBtn.place(rely=0.5,relx=0.2)


btn9 = Button(frame,text="About us",bg='black', fg='white',image=resizeImg, command = aboutUs,relief='ridge',bd=0,compound=CENTER)
